...
struct token_pattern token_patterns[TERMINAL_COUNT] = {
    ...
    TOKEN_PATTERN("([0-9]*.)?[0-9]+", FLOAT, NULL), //5
    ...
    NAME_KEYWORD_PATTERN(")", "\\)", RPAREN, NULL), //20
    ...
    KEYWORD_PATTERN(":", ISTYPEOF, NULL),   //30
