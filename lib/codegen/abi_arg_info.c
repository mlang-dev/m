...
struct abi_arg_info _create_direct(struct type_exp *type, TargetType target_type, unsigned direct_offset, TargetType padding_type, bool can_be_flattened)
{
...
struct abi_arg_info _create_indirect(struct type_exp *type, unsigned indirect_align, bool indirect_byval, bool indirect_realign, TargetType padding_type)
{
    struct abi_arg_info aai;
    aai.type = type;
