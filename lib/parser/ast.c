...
struct ast_node *unary_node_new(symbol op, enum op_code opcode, struct ast_node *operand, struct source_location loc)
{
...
{
    return unary_node_new(orig_node->unop->op, orig_node->unop->opcode,
