...
{
    pgen_init();
    char grammar_path[1024];
    sprintf(grammar_path, "%spgen/%s/%s_grammar.pgn", source_folder, lang_name, lang_name);
    printf("parsing grammar file %s ...\n", grammar_path);
    char header_filepath[1024];
    sprintf(header_filepath, "%sparser/%s_parsing_table.h", header_folder, lang_name);
    char source_filepath[1024];
    sprintf(source_filepath, "%sparser/%s_parsing_table.c", source_folder, lang_name);
    ...
    sprintf(header_filepath, "%sparser/", header_folder);
    char pgen_header_folder[1024];
    sprintf(pgen_header_folder, "%spgen/def", header_folder);
