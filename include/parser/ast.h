...
struct ast_node *type_value_node_new(struct ast_node *parent, struct source_location loc, struct ast_node *body, symbol type_name);
struct ast_node *func_type_node_default_new(struct ast_node *parent, struct source_location loc,
    symbol name,
    struct array *args, struct type_exp *ret_type, bool is_variadic, bool is_external);

struct ast_node *if_node_new(struct ast_node *parent, struct source_location loc, struct ast_node *condition, struct ast_node *then_node,
