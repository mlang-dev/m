...
struct ast_node *var_node_new(symbol var_name, bool is_ref_annotated, struct ast_node *is_of_type, struct ast_node *init_value, bool is_global, struct source_location loc);
