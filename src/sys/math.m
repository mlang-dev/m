...
func frexp(__x:f64, __exponent:&int) -> f64
func __frexp(__x:f64, __exponent:&int) -> f64
...
func modf(__x:f64, __iptr:&f64) -> f64
func __modf(__x:f64, __iptr:&f64) -> f64
...
func lgamma_r(arg0:f64, __signgamp:&int) -> f64
func __lgamma_r(arg0:f64, __signgamp:&int) -> f64
...
func remquo(__x:f64, __y:f64, __quo:&int) -> f64
func __remquo(__x:f64, __y:f64, __quo:&int) -> f64
