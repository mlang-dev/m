...
fun frexp __x:f64 __exponent:string -> f64
fun __frexp __x:f64 __exponent:string -> f64
...
fun modf __x:f64 __iptr:string -> f64
fun __modf __x:f64 __iptr:string -> f64
...
fun lgamma_r arg0:f64 __signgamp:string -> f64
fun __lgamma_r arg0:f64 __signgamp:string -> f64
...
fun remquo __x:f64 __y:f64 __quo:string -> f64
fun __remquo __x:f64 __y:f64 __quo:string -> f64
